...
class o2o2 : public solver {
  ...
  /* Last result of interpolating opensmt */
  result d_last_iopensmt2_result;

public:

  /** Constructor */
  o2o2(expr::term_manager& tm, const options& opts, utils::statistics& stats);
